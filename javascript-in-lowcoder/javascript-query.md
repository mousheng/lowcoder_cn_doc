...
在Lowcoder中构建应用时，相较于在 `{{ }}`​ 内编写 [JavaScript 表达式](../javascript-in-lowcoder/writing-javascript)，通过 JavaScript 查询功能可以编写和运行更加复杂的 JavaScript 代码。这里的 JavaScript 代码支持的功能包括：
...
具体参考 [JavaScript 表达式](../javascript-in-lowcoder/writing-javascript)文档。
